...
implements ListQuantity 
{
     ...
     */
    protected ListQuantityImpl ( URI uri, String nodeName, ValueMapping mapping )
    {
    	this(uri, nodeName, -1);
